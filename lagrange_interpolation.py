...
Original file is located at
    https://colab.research.google.com/drive/1ZtPY0O8bzE-CJVm3Uo4Kl-mZEdtMm2cu
...
result_p = Lagrange_Polynomial(data_x, data_y)

print(result_p)

error = abs(y - result_p([x]))
print("Error: ",error)



# print((4*-1.5 -result_p([-1.5])))
